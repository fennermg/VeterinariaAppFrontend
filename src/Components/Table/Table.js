...
export function clickeableCell({ value, column, row }) {
  return (
    <div className="flex items-center">
      <button>
        <div className="ml-4">
        ...
        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
          <div className="flex gap-x-2 items-baseline">
            <span className="text-sm text-gray-700">
              Pagina <span className="font-medium">{state.pageIndex + 1}</span> de <span className="font-medium">{pageOptions.length}</span>
            </span>
            <label>
              <span className="sr-only">Elementos por pagina</span>
              <select
